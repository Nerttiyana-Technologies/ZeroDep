...
/// <summary>
/// Encodes a <see cref="DecodedImage"/> as a 24-bit BMP (pure BCL). Tesseract's Leptonica reads
/// encoded images from memory, so the raw decoder samples are wrapped in a minimal BMP container.
/// </summary>
